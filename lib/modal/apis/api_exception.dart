...
class UnauthorisedException extends ApiException {
  UnauthorisedException([String? msg]) : super(message: msg, prefix: 'UnAuthorized Request:');
}

class ServerException extends ApiException {
  ServerException([String? msg]) : super(message: msg, prefix: 'Page not fount in Server:');
}
