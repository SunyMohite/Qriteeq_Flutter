...
class MyFavouriteInsidePage extends StatefulWidget {
  final MyFavouriteResult? favResults;

  const MyFavouriteInsidePage({Key? key, this.favResults}) : super(key: key);

  @override
  State<MyFavouriteInsidePage> createState() => _MyFavouriteInsidePageState();
}

class _MyFavouriteInsidePageState extends State<MyFavouriteInsidePage>
