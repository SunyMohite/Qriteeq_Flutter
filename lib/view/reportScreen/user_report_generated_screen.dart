...
class UserReportGeneratedScreen extends StatefulWidget {
  final UserGenerateReportResults userGenerateReportData;

  const UserReportGeneratedScreen({
    Key? key,
    required this.userGenerateReportData,
  }) : super(key: key);

  @override
  State<UserReportGeneratedScreen> createState() => _GenerateReportState();
}

class _GenerateReportState extends State<UserReportGeneratedScreen> {
  ...
  @override
  void initState() {
    isExistsUser = widget.userGenerateReportData.reportOf!.active;
    if (widget.userGenerateReportData.reportOf!.id!.isNotEmpty) {
      queryKey = VariableUtils.userId;
      queryValue = widget.userGenerateReportData.reportOf!.id!;
    } else if (widget.userGenerateReportData.reportOf!.phone!.isNotEmpty) {
      queryKey = VariableUtils.phone;
      queryValue = widget.userGenerateReportData.reportOf!.phone!;
    } else if (widget.userGenerateReportData.reportOf!.email!.isNotEmpty) {
      queryKey = VariableUtils.email;
      queryValue = widget.userGenerateReportData.reportOf!.email!;
    } else if (widget.userGenerateReportData.reportOf!.profileUrl!.isNotEmpty) {
      queryKey = VariableUtils.profileUrl;
      queryValue = widget.userGenerateReportData.reportOf!.profileUrl!;
    }
    userFeedBackId = queryValue;
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "${widget.userGenerateReportData.reportOf!.userIdentity} Report",
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    Container(
                      decoration:
                          BoxDecoration(color: ColorUtils.white, boxShadow: [
                        BoxShadow(
                          ...
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    widget.userGenerateReportData.reportOf!
                                                .id ==
                                            PreferenceManagerUtils.getLoginId()
                                        ? VariableUtils.you
                                        : widget.userGenerateReportData
                                            .reportOf!.userIdentity!,
                                    style: TextStyle(
                                        fontSize: 15.sp,
                            ...
                            Row(
                              ...
                              children: [
                                OctoImageWidget(
                                  profileLink: widget
                                      .userGenerateReportData.reportOf!.avatar,
                                ),
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        '${widget.userGenerateReportData.feedbacksReceivedCount}',
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        '${widget.userGenerateReportData.feedbacksPostedCount}',
                                        style: FontTextStyle.roboto10W5Black1E,
                                        textAlign: TextAlign.center,
                                      ),
                                      SizeConfig.sH05,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        const ChatLabelView(
                                            title: VariableUtils.postedFeedback,
                                            colorName: ColorUtils.chartReview),
                                        SizeConfig.sH1,
                                        const ChatLabelView(
                                            title:
                                                VariableUtils.receivedFeedback,
                                            colorName: ColorUtils.chartPosted),
                                      ],
                                    ),
                                  )
                                ],
                          ...
                          Column(
                            children: [
                              ...
                              StoreRatingViewWidget(
                                title: 'Amazing',
                                image: amazingImg,
                                percent: widget.userGenerateReportData.score!
                                        .amazing! /
                                    100,
                              ),
                              StoreRatingViewWidget(
                                ...
                                image: greatImg,
                                percent: widget
                                        .userGenerateReportData.score!.great! /
                                    100,
                              ),
                              StoreRatingViewWidget(
                                title: 'Fine',
                                image: fineImg,
                                percent:
                                    widget.userGenerateReportData.score!.fine! /
                                        100,
                              ),
                              StoreRatingViewWidget(
                                title: 'Poor',
                                image: poorImg,
                                percent:
                                    widget.userGenerateReportData.score!.poor! /
                                        100,
                              ),
                              StoreRatingViewWidget(
                                title: 'Bad',
                                image: badImg,
                                percent:
                                    widget.userGenerateReportData.score!.bad! /
                                        100,
                              ),
                            ],
                          )
                        ...
                        : ImageFiltered(
                            ...
                            child: VariableUtils.imageFormatList.contains(
                                ...
                                : VariableUtils.videoFormatList.contains(
                                    ...
                                    : VariableUtils.documentFormatList.contains(
                                            myFeedBackResultsData
                                                .document!.first.ext
                                                .toString()
                                                .toUpperCase())
